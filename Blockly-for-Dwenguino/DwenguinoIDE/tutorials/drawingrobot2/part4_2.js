...
tutorials.drawingRobot2_4_2 = {
    ...
    id: "v2_part4_2",
    label: MSG.tutorials.drawingrobot['part4_2'].label,
    onStart: function(){
      ...
      if($('#tutorial_example_close')[0]){
        $('#tutorial_example_img').attr("src","./DwenguinoIDE/img/tutorials/drawingrobot/4.png");
      } else {
        ...
        + '      <img id="tutorial_example_img" class="tutorial tutorial_img_txt tutorial_img" src="./DwenguinoIDE/img/tutorials/drawingrobot/4.png">'
        + '    </div>'
        + '  </div>'
    ...
    onNext: function(){
      ...
      if(curr === 2){
        drawingrobotTutorialChecks.checkExercise4_2(true);
      }
